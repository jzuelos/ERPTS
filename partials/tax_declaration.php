<section class="container mt-5" id="declaration-section">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <button type="button" class="btn btn-outline-primary btn-sm" 
                data-bs-toggle="modal" data-bs-target="#editDeclarationProperty" 
                <?= $disableButton ?>>
            Edit
        </button>
    </div>
        ...
        <form>
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="cancelsTD" 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="previousPin" 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="enteredInRPAREForBy" 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="previousOwner" 
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="taxDeclarationNumberModal" 
                                   name="arp_no" maxlength="25" placeholder="Enter Tax Declaration Number"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="provincialAssessorModal" 
                                   name="pro_assess" maxlength="20" placeholder="Enter Provincial Assessor"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="provincialDateModal" 
                                   name="pro_date" value="<?= htmlspecialchars($rpu_declaration['pro_date'] ?? '') ?>">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="municipalAssessorModal" 
                                   name="mun_assess" maxlength="20" placeholder="Enter City/Municipal Assessor"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="municipalDateModal" 
                                   name="mun_date" value="<?= htmlspecialchars($rpu_declaration['mun_date'] ?? '') ?>">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="cancelsTDModal" class="form-label">Cancels TD Number</label>
                            <input type="text" class="form-control" id="cancelsTDModal" 
                                   name="td_cancel" maxlength="20" placeholder="Enter Cancels TD Number"
                                   value="<?= htmlspecialchars($rpu_declaration['td_cancel'] ?? '') ?>">
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="previousPinModal" class="form-label">Previous Pin</label>
                            <input type="text" class="form-control" id="previousPinModal" 
                                   name="previous_pin" maxlength="20" placeholder="Enter Previous Pin"
                                   value="<?= htmlspecialchars($rpu_declaration['previous_pin'] ?? '') ?>">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="taxYearModal" class="form-label">Tax Begin With Year</label>
                            <input type="date" class="form-control" id="taxYearModal" 
                                   name="tax_year" value="<?= htmlspecialchars($rpu_declaration['tax_year'] ?? '') ?>">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="enteredInRPAREForByModal" class="form-label">Entered in RPARE For By</label>
                            <input type="text" class="form-control" id="enteredInRPAREForByModal" 
                                   name="entered_by" placeholder="Enter Value"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="enteredInRPAREForYearModal" 
                                   name="entered_year" value="<?= htmlspecialchars($rpu_declaration['entered_year'] ?? '') ?>">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="previousOwnerModal" class="form-label">Previous Owner</label>
                            <input type="text" class="form-control" id="previousOwnerModal" 
                                   name="prev_own" maxlength="50" placeholder="Enter Previous Owner"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="previousAssessedValueModal" 
                                   name="prev_assess" maxlength="20" placeholder="Enter Assessed Value"
