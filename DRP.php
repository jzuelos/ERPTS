...
<body>
    <div class="section">
        ...
        <p><span class="bold">Assessment of Real Property No.:</span> <u>_______________</u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="bold">Property Index No.:</span> <u>_______________</u></p>
    </div>
    ...
    <div class="section">
        <p><span class="bold">Owner:</span> ___________________________________ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="bold">Address:</span> __________________________________</p>
        <p><span class="bold">Administration:</span> ____________________________ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="bold">Address:</span> __________________________________</p>
    </div>
    ...
    <div class="section">
        <p><span class="bold">OCT/TCT No.:</span> <u>__________</u> &nbsp;&nbsp; <span class="bold">Survey No.:</span> <u>__________</u> &nbsp;&nbsp; <span class="bold">Lot No.:</span> <u>__________</u> &nbsp;&nbsp; <span class="bold">Blk No.:</span> <u>__________</u></p>
    </div>

    <div class="section">
        <p class="bold">Boundaries:</p>
        <p>North: ___________________________________ &nbsp;&nbsp; South: ___________________________________</p>
    ...
    <div class="section">
        ...
        <div style="display: flex; justify-content: space-between; margin-top: 20px;">
            ...
            <div style="flex: 3;"></div>
            <div style="flex: 2; text-align: center;">
                <p><span class="bold">TOTAL</span><br>₱_______________</p>
            </div>
        </div>
        <div style="margin-top: 5px;">
            ...
            <p style="display: inline-block; border-bottom: 1px solid black; width: 100%;"></p>
            <div style="clear: both; text-align: center; font-style: italic;">
                (Amount in Words)
            </div>
        </div>        
    </div>      
    ...
    <div class="section">
        <p style="display: flex; justify-content: space-between; align-items: flex-end; margin: 0;">
            ...
            <span style="border-bottom: 1px solid black; display: inline-block; width: 20%; height: 1px;"></span>
        </p>
    </div>

    <div class="section">
        <!-- Area section -->
        <p><span class="bold">Area:</span> __________________________</p>
