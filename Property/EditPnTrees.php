    ...
    <div class="col-lg-12 col-xl-13"> 
      <div class="card border-0 shadow p-4 rounded-3 compact-form">
        <form>
          ...
          <!-- Administrator Info (Left) + Plants/Trees Appraisal (Right) -->
          <div class="row mt-4">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="fruitBearing" id="fruitYes" required>
                    <label class="form-check-label" for="fruitYes">Yes</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="fruitBearing" id="fruitNo" required>
...
<!-- Edit Modal -->
<div class="modal fade" id="editPnT" tabindex="-1" aria-labelledby="editPnTLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editPnTLabel">Edit Plants and Trees</h5>
      ...
      <div class="modal-body">
        <form id="plantsForm">
          ...
          <div class="row">
            <div class="col-md-6 mb-4">
              <label for="surveyNumber" class="form-label">Survey Number</label>
              <input type="text" id="surveyNumber" class="form-control"  maxlength="20" required>
            </div>
            <div class="col-md-6 mb-4">
              <label for="landPin" class="form-label">Land PIN</label>
              <input type="text" id="landPin" class="form-control" maxlength="20" required>
            </div>
          </div>

          <!-- Administrator Info + Plants/Trees Appraisal -->
          <div class="row mt-4">
            <!-- Administrator Information -->
            <div class="col-md-6">
              <h5 class="section-title">Administrator Information</h5>
